...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,backend,backend:8000', cast=Csv())
...
DHL_ENVIRONMENT = config('DHL_ENVIRONMENT', default='development')
