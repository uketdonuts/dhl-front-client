...
class DHLServiceSimulator:
    ...
    def get_rate(self, origin, destination, weight, dimensions, declared_weight=None, content_type="P"):
        ...
        return self.simulator.simulate_rate_response(origin_code, destination_code, weight)
...
def get_dhl_service(environment="development"):
    """
    ...
    """
    if environment == "development" or os.getenv('DHL_SIMULATE_MODE', 'true').lower() == 'true':
